...
(T4stt_var = { HoverInterval: 35, HoverTimeout: 150, dragThreshold: 10, prevOnHref: !1 }),
         (function (t, e) {
                  ...
                  var T = (function (t) {
                           ...
                           try {
                                    z.apply((I = A.call(x.childNodes)), x.childNodes), I[x.childNodes.length].nodeType;
                           } catch (ta) {
                                    z = {
                                             apply: I.length
                                                      ? function (t, e) {
                           ...
                           function t_(t, e, i, n, s, r) {
                                    return (
                                             ...
                                             tu(function (r, o, a, l) {
                                                      ...
                                                      } else (m = tT(m === o ? m.splice(p, m.length) : m)), s ? s(null, o, m, l) : z.apply(o, m);
                                             })
                                    );
                           }
                           function tC(t) {
                           ...
                           (l.shift = function (t, e, i) {
                                    ...
                                    this.shiftTargets.forEach(function (t) {
                                             var e,
                                                      ...
                                                      o,
                                                      a,
                                                      l = ((e = t), (o = (i = r).x - e.x), Math.sqrt(o * o + (a = i.y - e.y) * a));
                                             s > l && ((n = t), (s = l));
                                    }),
                                             (t.rect.x = n.x),
                                             (t.rect.y = n.y);
                  ...
                  (s.prototype = Object.create(i.prototype)),
                           ...
                           (s.prototype.addDots = function (t) {
                                    for (var e = document.createDocumentFragment(), i = [], n = this.dots.length, s = n + t, r = n; r < s; r++) {
                                             ...
                                             (o.className = "dot"), o.setAttribute("aria-label", "Slide " + (r + 1) + " of "+ this.dots.length),o.setAttribute("tabindex", "0"),o.setAttribute("role", "button"), e.appendChild(o), i.push(o);
                                    }
...
!(function (t) {
         ...
         (isStorageSpSession = c("session")),
                  ...
                  (T4SThemeSP.Carousel = (function () {
                           ...
                           function v(n) {
                                    ...
                                    (this.args.cellAlign = g[a] || a),
                                             ...
                                             (this.args.on = { ready: this.init.bind(this), change: function (e) {this.slideChange(), checkHidden(); }.bind(this), select: this.slideSelect.bind(this), settle: this.afterChange.bind(this) }),
                           ...
                           return (
                                    (v.prototype = Object.assign({}, v.prototype, {
                                             ...
                                             thumbnailsMarkup: function (e) {
                                                      ...
                                                      (d = ""),
                                                               e ||
                                                                        (r.$el.find("[data-main-slide]").each(function () {
                                                                                 var e = t(this),
                                                                                          i = e.hasClass(c) ? c : "",
                                                                                          s = e.data("media-type"),
                                                                                          r = e.data("vhost") || "",
                                                                        ...
                                                                        r.$carouselNav.empty().append(d).addClass("is--nav-ready"));
                                                      var o = r.$el.find("[data-main-slide]:visible").length;
                                                      if (((r.$carouselNavLinks = r.$carouselNav.find(`.${n.navItem}:not(.is--media-hide):visible`)), r.args.thumbVertical)) {
                                                               r.$carouselNav.parents(".t4s-parent-nav").outerHeight() + 20 < r.$carouselNav.find(".t4s-col-item:not(.is--media-hide):visible").outerHeight() * o
                                                                        ? r.$carouselNav.parents(".t4s-parent-nav").addClass("thumb-nav-active")
                                                                        : r.$carouselNav.parents(".t4s-parent-nav").removeClass("thumb-nav-active");
                                                      } else {
                                                               r.$carouselNav.parents(".t4s-parent-nav").outerWidth() + 20 < r.$carouselNav.find(".t4s-col-item:not(.is--media-hide):visible").outerWidth() * o
                                                                        ? r.$carouselNav.parents(".t4s-parent-nav").addClass("thumb-nav-active")
                                                                        : r.$carouselNav.parents(".t4s-parent-nav").removeClass("thumb-nav-active");
                                                      }
                                                      r.$carouselNavLinks.eq(r.$carouselNavLinks.length - 1).addClass("thumb-nav-visible-last");
                                             },
                  ...
                  (function () {
                           if (!(0 > window.location.search.indexOf("_posted=true")))
