                                    ...
                                    M = function () {
                                             return (
                                                      (T = !T)
                                                               ...
                                                               : (k(),
                                                                 setTimeout(function () {
                                                                          T || t.addClass(s, "pswp__share-modal--fade-in"), document.querySelector("#share_modal").setAttribute("aria-expanded", "true"), document.querySelector(".pswp__button--share").setAttribute("aria-expanded", "true"),;
                                                                 }, 30)),
                                                      T || O(),
                                                      !1
                                             );
