!(function (e, t) {
         ...
         return function (e, t, n, o) {
                  ...
                  var l,
                           ...
                           De = function (e, t, n, o, i) {
                                    (!xe || (i && i !== a.currItem)) && (o /= i ? i.fitRatio : a.currItem.fitRatio), (e[D] = y + t + "px, " + n + "px" + w + " scale(" + o + ")");
                           },
                           ke = function (e) {
                                    te && (e && (v > a.currItem.fitRatio ? xe || (jt(a.currItem, !1, !0), (xe = !0)) : xe && (jt(a.currItem), (xe = !1))), De(te, de.x, de.y, v));
                           },
                           Me = function (e) {
                           ...
                           Pe = null,
                           Ze = function () {
                                    Pe && (i.unbind(document, "mousemove", Ze), i.addClass(e, "pswp--has_mouse"), (r.mouseUsed = !0), Ee("mouseUsed")),
                           ...
                           He = function (e) {
                                    e && (V || q || ne || H) && (e.preventDefault(), e.stopPropagation());
                           },
                           We = function () {
                           ...
                           Ye = 0,
                           qe = function (e) {
                                    Ge[e] && (Ge[e].raf && O(Ge[e].raf), Ye--, delete Ge[e]);
                           },
                           Ve = function (e) {
                                    Ge[e] && qe(e), Ge[e] || (Ye++, (Ge[e] = {}));
                           },
                           Xe = function () {
                           ...
                           je = function (e, t, n, o, i, a, r) {
                                    ...
                                    var u = function () {
                                             if (Ge[e]) {
                                                      if ((l = _e() - s) >= o) return qe(e), a(n), void (r && r());
                                                      a((n - t) * i(l / o) + t), (Ge[e].raf = F(u));
                                             }
                                    };
                                    u();
                           },
                           $e = {
                                    ...
                                    init: function () {
                                             if (!l && !s) {
                                                      ...
                                                      for ((Z.animationName && Z.transform && !o) || (r.showAnimationDuration = r.hideAnimationDuration = 0), n = 0; n < ye.length; n++) a["init" + ye[n]]();
                                                      t && (a.ui = new t(a, i)).init(),
                                                               ...
                                                               r.modal && (ge ? (e.style.position = "fixed") : ((e.style.position = "absolute"), (e.style.top = i.getScrollY() + "px"))),
                                                               void 0 === P && (Ee("initialLayout"), (P = R = i.getScrollY()));
                                                      var u = "pswp--open ";
                                                      for (
                                                      ...
                                                      L || i.bind(a.scrollWrap, f, a),
                                                               ...
                                                               ge ||
                                                                        (x = setInterval(function () {
                                                                                 Ye || G || Q || v !== a.currItem.initialZoomLevel || a.updateSize();
                                                                        }, 1e3)),
                                    ...
                                    goTo: function (e) {
                                             var t = (e = Ce(e)) - c;
                                             (ve = t), (c = e), (a.currItem = Ut(c)), (me -= t), Oe(he.x * me), Xe(), (ne = !1), a.updateCurrItem();
                                    },
                                    next: function () {
                                             a.goTo(c + 1);
                                    },
                                    ...
                                    updateCurrZoomItem: function (e) {
                                             ...
                                             (ee = a.currItem.bounds), (g = v = a.currItem.initialZoomLevel), (de.x = ee.center.x), (de.y = ee.center.y), e && Ee("afterChange");
                                    },
                                    ...
                                    updateCurrItem: function (e) {
                                             if (0 !== ve) {
                                                      var t,
                                                               n = Math.abs(ve);
                                                      if (!(e && n < 2)) {
                                                               (a.currItem = Ut(c)), (xe = !1), Ee("beforeChange", ve), n >= 3 && ((p += ve + (ve > 0 ? -3 : 3)), (n = 3));
                                                               for (var o = 0; o < n; o++)
                                                                        ve > 0
                                                                                 ? ((t = C.shift()), (C[2] = t), Fe((++p + 2) * he.x, t.el.style), a.setContent(t, c - n + o + 1 + 1))
                                                                                 : ((t = C.pop()), C.unshift(t), Fe(--p * he.x, t.el.style), a.setContent(t, c + n - o - 1 - 1));
                                                               if (te && 1 === Math.abs(ve)) {
                                                                        var i = Ut(T);
                                                                        i.initialZoomLevel !== v && (Yt(i, pe), jt(i), Me(i));
                                                               }
                                                               (ve = 0), a.updateCurrZoomItem(), (T = c), Ee("afterChange");
                                                      }
                                             }
                                    },
                                    updateSize: function (t) {
                                             if (!ge && r.modal) {
                                                      var n = i.getScrollY();
                                                      if ((P !== n && ((e.style.top = n + "px"), (P = n)), !t && we.x === window.innerWidth && we.y === window.innerHeight)) return;
                                                      (we.x = window.innerWidth), (we.y = window.innerHeight), (e.style.height = we.y + "px");
                                             }
                                             if (((pe.x = a.scrollWrap.clientWidth), (pe.y = a.scrollWrap.clientHeight), We(), (he.x = pe.x + Math.round(pe.x * r.spacing)), (he.y = pe.y), Oe(he.x * me), Ee("beforeResize"), void 0 !== p)) {
                                                      for (var o, l, s, u = 0; u < 3; u++)
                                                               (o = C[u]),
                                                                        Fe((u + p) * he.x, o.el.style),
                                                                        (s = c + u - 1),
                                                                        r.loop && Kt() > 2 && (s = Ce(s)),
                                                                        (l = Ut(s)) && (b || l.needsUpdate || !l.bounds)
                                                                                 ? (a.cleanSlide(l), a.setContent(o, s), 1 === u && ((a.currItem = l), a.updateCurrZoomItem(!0)), (l.needsUpdate = !1))
                                                                                 : -1 === o.index && s >= 0 && a.setContent(o, s),
                                                                        l && l.container && (Yt(l, pe), jt(l), Me(l));
                                                      b = !1;
                                             }
                                             (g = v = a.currItem.initialZoomLevel), (ee = a.currItem.bounds) && ((de.x = ee.center.x), (de.y = ee.center.y), ke(!0)), Ee("resize");
                                    },
                                    zoomTo: function (e, t, n, o, a) {
                                             ...
                                             Le(l);
                                             var d = function (t) {
                                                      1 === t ? ((v = e), (de.x = l.x), (de.y = l.y)) : ((v = (e - s) * t + s), (de.x = (l.x - u) * t + u), (de.y = (l.y - c) * t + c)), a && a(t), ke(1 === t);
                                             };
                           ...
                           gt = {},
                           yt = function (e, t) {
                                    return (gt.prevent = !vt(e.target, r.isClickableElement)), Ee("preventDragEvent", e, t, gt), gt.prevent;
                           },
                           wt = function (e, t) {
                           ...
                           Et = function (e) {
                                    ...
                                    return (
                                             k
                                                      ...
                                                      ? e.touches && e.touches.length > 0 && ((It[0] = wt(e.touches[0], Ct)), e.touches.length > 1 && (It[1] = wt(e.touches[1], Tt)))
                                    ...
                                    return (
                                             ...
                                             (te
                                                      ? "h" !== oe ||
                                                        ...
                                                        q ||
                                                        (u
                                                                 ? (s > ee.min[e] && ((n = r.panEndFriction), ee.min[e], (o = ee.min[e] - ce[e])),
                                                                   (o <= 0 || d < 0) && Kt() > 1 ? ((l = c), d < 0 && c > it.x && (l = it.x)) : ee.min.x !== ee.max.x && (i = s))
                                                                 : (s < ee.max[e] && ((n = r.panEndFriction), ee.max[e], (o = ce[e] - ee.max[e])),
                                                                   (o <= 0 || d > 0) && Kt() > 1 ? ((l = c), d > 0 && c < it.x && (l = it.x)) : ee.min.x !== ee.max.x && (i = s)))
                                                      : (l = c),
                                             "x" !== e)
                                                      ? void (ne || j || (v > a.currItem.fitRatio && (de[e] += t[e] * n)))
                                                      : (void 0 !== l && (Oe(l, !0), (j = l !== it.x)), ee.min.x !== ee.max.x && (void 0 !== i ? (de.x = i) : j || (de.x += t.x * n)), void 0 !== l)
                                    );
                           },
                           St = function (e) {
                                    if (!("mousedown" === e.type && e.button > 0)) {
                                             ...
                                             if (!W || "mousedown" !== e.type) {
                                                      if ((yt(e, !0) && e.preventDefault(), Ee("pointerDown"), k)) {
                           ...
                           kt = function () {
                                    if ($) {
                                             var e = $.length;
                                             if (0 !== e)
                                                      if ((Re(Qe, $[0]), (et.x = Qe.x - tt.x), (et.y = Qe.y - tt.y), Q && e > 1)) {
                                                               if (
                                                                        ((tt.x = Qe.x),
                                                                        (tt.y = Qe.y),
                                                                        !et.x &&
                                                                        ...
                                                                        return;
                                                               Re(Je, $[1]), q || ((q = !0), Ee("zoomGestureStarted"));
                                                               var t = mt(Qe, Je),
                                                                        n = Rt(t);
                                                               ...
                                                               var o = 1,
                                                                        ...
                                                                        l = Ue();
                                                               if (n < i)
                                                                        if (r.pinchToClose && !le && g <= a.currItem.initialZoomLevel) {
                                                                                 var s = 1 - (i - n) / (i / 1.2);
                                                                                 Se(s), Ee("onPinchClose", s), (ae = !0);
                                                                        } else (o = (i - n) / i) > 1 && (o = 1), (n = i - o * (i / 3));
                                                               else n > l && ((o = (n - l) / (6 * i)) > 1 && (o = 1), (n = l + o * i));
                                                               o < 0 && (o = 0), xt(Qe, Je, st), (ue.x += st.x - pt.x), (ue.y += st.y - pt.y), Re(pt, st), (de.x = Ae("x", n)), (de.y = Ae("y", n)), (B = n > v), (v = n), ke();
                                                      } else {
                                                               if (!oe) return;
                                                               if (
                                                                        (ie && ((ie = !1), Math.abs(et.x) >= 10 && (et.x -= $[0].x - nt.x), Math.abs(et.y) >= 10 && (et.y -= $[0].y - nt.y)),
                                                                        (tt.x = Qe.x),
                                                                        (tt.y = Qe.y),
                                                                        0 === et.x && 0 === et.y)
                                                               )
                                                               ...
                                                               if ("v" === oe && r.closeOnVerticalDrag && "fit" === r.scaleMode && v === a.currItem.initialZoomLevel) {
                                                                        (ue.y += et.y), (de.y += et.y);
                                                                        var u = bt();
                                                                        return (H = !0), Ee("onVerticalDrag", u), Se(u), void ke();
                                                               }
                                                               (function (e, t, n) {
                                                                        if (e - U > 50) {
                           ...
                           Mt = function (e) {
                                    ...
                                    var t;
                                    if ((Ee("pointerUp"), yt(e, !1) && e.preventDefault(), k)) {
                                    ...
                                    var u = -1;
                                    if (
                                             (0 === s && ((G = !1), i.unbind(window, m, a), ft(), Q ? (u = 0) : -1 !== ut && (u = _e() - ut)),
                                             (ut = 1 === s ? _e() : -1),
                                             (o = -1 !== u && u < 150 ? "zoom" : "swipe"),
                                             Q && s < 2 && ((Q = !1), 1 === s && (o = "zoomPointerUp"), Ee("zoomGestureEnded")),
                                             ($ = null),
                                             V || q || ne || H)
                                    )
                                             if ((Xe(), K || (K = Ft()), K.calculateSwipeSpeed("x"), H))
                                                      if (bt() < r.verticalDragRange) a.close();
                                                      else {
                                                               var c = de.y,
                                                                        d = re;
                                                               je("verticalDrag", 0, 1, 300, i.easing.cubic.out, function (e) {
                                                                        (de.y = (a.currItem.initialPosition.y - c) * e + c), Se((1 - d) * e + d), ke();
                                                               }),
                                                                        Ee("onVerticalDrag", 1);
                                                      }
                                             else {
                                                      ...
                                                      if (!ne) return "swipe" !== o ? void Lt() : void (!j && v > a.currItem.fitRatio && Ot(K));
                                             }
                           },
                           Ft = function () {
                                    var e,
                                             ...
                                             n = {
                                                      ...
                                                      calculateSwipeSpeed: function (o) {
                                                               at.length > 1 ? ((e = _e() - U + 50), (t = at[at.length - 2][o])) : ((e = _e() - N), (t = nt[o])),
                                                      ...
                                                      calculateOverBoundsAnimOffset: function (e, t) {
                                                               n.backAnimStarted[e] ||
                                                                        (de[e] > ee.min[e] ? (n.backAnimDestination[e] = ee.min[e]) : de[e] < ee.max[e] && (n.backAnimDestination[e] = ee.max[e]),
                                                      ...
                                                      panAnimLoop: function () {
                                                               if (
                                                                        Ge.zoomPan &&
                                                                        ((Ge.zoomPan.raf = F(n.panAnimLoop)),
                                                                        (n.now = _e()),
                                                                        ...
                                                                        return (de.x = Math.round(de.x)), (de.y = Math.round(de.y)), ke(), void qe("zoomPan");
                                                      },
                                             };
                                    return n;
                           },
                           Ot = function (e) {
                                    return (
                                             ...
                                             Math.abs(e.lastFlickSpeed.x) <= 0.05 && Math.abs(e.lastFlickSpeed.y) <= 0.05
                                                      ...
                                                      : (Ve("zoomPan"), (e.lastNow = _e()), void e.panAnimLoop())
                                    );
                           },
                           At = function (e, t) {
                                    var n, o, l;
                                    ...
                                    var d,
                                             ...
                                             m = Math.abs(p - ct.x);
                                    return (
                                             n || p > ct.x == t.lastFlickSpeed.x > 0 ? ((d = Math.abs(t.lastFlickSpeed.x) > 0 ? m / Math.abs(t.lastFlickSpeed.x) : 333), (d = Math.min(d, 400)), (d = Math.max(d, 250))) : (d = 333),
                                             lt === c && (n = !1),
                                             (ne = !0),
                                             Ee("mainScrollAnimStart"),
                                             je("mainScroll", ct.x, p, d, i.easing.cubic.out, Oe, function () {
                           ...
                           publicMethods: {
                                    initGestures: function () {
                                             ...
                                             (k = Z.pointerEvent) && Z.touch && (Z.touch = !1),
                                                      ...
                                                      (m = E + " " + _ + " " + S),
                                                      (f = I),
                                                      k && !M && (M = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1),
                                                      (a.likelyTouchDevice = M),
                                                      (h[I] = St),
                                                      (h[E] = Dt),
                                                      (h[_] = Mt),
                                                      S && (h[S] = h[_]),
                                                      Z.touch && ((f += " mousedown"), (m += " mousemove mouseup"), (h.mousedown = h[I]), (h.mousemove = h[E]), (h.mouseup = h[_])),
                  ...
                  var Pt,
                           ...
                           Bt = function (t, n, o, l) {
                                             ...
                                             p = function () {
                                                      qe("initialZoom"),
                                                               o
                                                                        ...
                                                                        : (Se(1), n && (n.style.display = "block"), i.addClass(e, "pswp--animated-in"), Ee("initialZoom" + (o ? "OutEnd" : "InEnd"))),
                                                               l && l(),
                                                               (Nt = !1);
                                             };
                                    if (!d || !s || void 0 === s.x)
                                    ...
                                    !(function () {
                                             ...
                                             t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"),
                                                      o || ((v = s.w / t.w), (de.x = s.x), (de.y = s.y - R), (a[l ? "template" : "bg"].style.opacity = 0.001), ke()),
                                                      Ve("initialZoom"),
                                                               ...
                                                               function () {
                                                                        if ((Ee("initialZoom" + (o ? "Out" : "In")), o)) {
                                                                                 var a = s.w / t.w,
                                                                                          ...
                                                                                          m = function (t) {
                                                                                                   1 === t
                                                                                                            ? ((v = a), (de.x = s.x), (de.y = s.y - P))
                                                                                                            : ((v = (a - u) * t + u), (de.x = (s.x - r.x) * t + r.x), (de.y = (s.y - P - r.y) * t + r.y)),
                                                                                                            ke(),
                                                                                                            l ? (e.style.opacity = 1 - t) : Se(c - t * c);
                                                                                          };
                                                                                 n ? je("initialZoom", 0, 1, d, i.easing.cubic.out, m, p) : (m(1), (Pt = setTimeout(p, d + 20)));
                                                                        } else (v = t.initialZoomLevel), Re(de, t.initialPosition), ke(), Se(1), l ? (e.style.opacity = 1) : Se(1), (Pt = setTimeout(p, d + 20));
                                                               },
                                                               o ? 25 : 90
                                                      ));
                                    })();
                           ...
                           Yt = function (e, t, n) {
                                    if (e.src && !e.loadError) {
                                             var o = !n;
                                             if ((o && (e.vGap || (e.vGap = { top: 0, bottom: 0 }), Ee("parseVerticalMargin", e)), (Ht.x = t.x), (Ht.y = t.y - e.vGap.top - e.vGap.bottom), o)) {
                                                      var i = Ht.x / e.w,
                                                               a = Ht.y / e.h;
                                                      e.fitRatio = i < a ? i : a;
                                                      var l = r.scaleMode;
                           ...
                           $t = function () {
                                    if (Wt.length) {
                                             for (var e, t = 0; t < Wt.length; t++) (e = Wt[t]).holder.index === e.index && qt(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
                                             Wt = [];
                                    }
                           };
                  be("Controller", {
                           publicMethods: {
                                    ...
                                    initController: function () {
                                             i.extend(r, Gt, !0),
                                                      ...
                                                      Ie("mainScrollAnimComplete", $t),
                                                      Ie("initialZoomInEnd", $t),
                                                      Ie("destroy", function () {
                                    ...
                                    setContent: function (e, t) {
                                             ...
                                             if (s) {
                                                      ...
                                                      if ((!s.src && s.html && (s.html.tagName ? u.appendChild(s.html) : (u.innerHTML = s.html)), Xt(s), Yt(s, pe), !s.src || s.loadError || s.loaded))
                                                               s.src && !s.loadError && (((o = i.createEl("pswp__img", "img")).style.opacity = 1), (o.src = s.src), jt(s, o), qt(0, s, u, o));
                                                      else {
                                                               if (
                                                                        ((s.loadComplete = function (n) {
                                                                                 if (l) {
                                                                                          if (e && e.index === t) {
                                                                                                   if (Xt(n, !0)) return (n.loadComplete = n.img = null), Yt(n, pe), Me(n), void (e.index === c && a.updateCurrZoomItem());
                                                                                                   n.imageAppended
                                                                                                            ? !Nt && n.placeholder && ((n.placeholder.style.display = "none"), (n.placeholder = null))
                                                                                                            : Z.transform && (ne || Nt)
                                                                                                            ? Wt.push({ item: n, baseDiv: u, img: n.img, index: t, holder: e, clearPlaceholder: !0 })
                                                                                                            : qt(0, n, u, n.img, 0, !0);
                                                                                          }
                                                               ...
                                                               s.loading || Vt(s), a.allowProgressiveImg() && (!zt && Z.transform ? Wt.push({ item: s, baseDiv: u, img: s.img, index: t, holder: e }) : qt(0, s, u, s.img, 0, !0));
                                                      }
                  ...
                  be("Tap", {
                           publicMethods: {
                                    initTap: function () {
                                             Ie("firstTouchStart", a.onTapStart),
                                                      Ie("touchRelease", a.onTapRelease),
                                                      Ie("destroy", function () {
                                                               (en = {}), (Qt = null);
                                                      });
                                    },
                           ...
                           be("DesktopZoom", {
                                    publicMethods: {
                                             ...
                                             handleMouseWheel: function (e) {
                                                      if (v <= a.currItem.fitRatio) return r.modal && (!r.closeOnScroll || Ye || G ? e.preventDefault() : D && Math.abs(e.deltaY) > 2 && ((u = !0), a.close())), !0;
                  ...
                  var nn,
                           ...
                           wn = function () {
                                    if ((an && clearTimeout(an), Ye || G)) an = setTimeout(wn, 500);
                                    else {
                                             ...
                                             fn ? "#" + n !== window.location.hash && history[cn ? "replaceState" : "pushState"]("", document.title, o) : cn ? mn.replace(o) : (mn.hash = n),
                                                      (cn = !0),
                  ...
                  be("History", {
                           publicMethods: {
                                    ...
                                    onHashChange: function () {
                                             return vn() === un ? ((dn = !0), void a.close()) : void (rn || ((ln = !0), a.goTo(yn().pid), (ln = !1)));
                                    },
                                    updateURL: function () {
                  ...
                  return function (e, t) {
                           var n,
                                    ...
                                    E = function (e) {
                                             ...
                                             for (var n, o, i = (e.target || e.srcElement).getAttribute("class") || "", a = 0; a < N.length; a++) (n = N[a]).onTap && i.indexOf("pswp__" + n.name) > -1 && (n.onTap(), (o = !0));
                                             if (o) {
                                             ...
                                             return (
                                                      (T = !T)
                                                               ? (t.removeClass(s, "pswp__share-modal--fade-in"),
                                                                 ...
                                                                 document.querySelector(".pswp__button.pswp__button--share").setAttribute("aria-expanded", "false"),
                                                                 setTimeout(function () {
                                                                          T && k();
                                                                 }, 300))
                                                               : (k(),
                                                                 setTimeout(function () {
                                                                          T || t.addClass(s, "pswp__share-modal--fade-in"), document.querySelector("#share_modal").setAttribute("aria-expanded", "true"), document.querySelector(".pswp__button.pswp__button--share").setAttribute("aria-expanded", "true"),;
                                                                 }, 30)),
                                                      T || O(),
                                                      !1
                                             );
                                    ...
                                    R = 0,
                                    L = function () {
                                             clearTimeout(w), (R = 0), c && x.setIdle(!1);
                                    },
                                    P = function (e) {
                                    ...
                                    z = function (e) {
                                             ...
                                             if (_()) {
                                                      ...
                                                      if (v.captionEl && "auto" === r.bottom)
                                                               if (
                                                                        (a || ((a = t.createEl("pswp__caption pswp__caption--fake")).appendChild(t.createEl("pswp__caption__center")), o.insertBefore(a, i), t.addClass(o, "pswp__ui--fit")),
                           ...
                           (x.init = function () {
                                    t.extend(e.options, I, !0),
                                             ...
                                             (function () {
                                                      ...
                                                      d("onVerticalDrag", function (e) {
                                                               C && e < 0.95 ? x.hideControls() : !C && e >= 0.95 && x.showControls();
                                                      }),
                                                               d("onPinchClose", function (t) {
                                                                        C && t < 0.9 ? (x.hideControls(), (e = !0)) : e && !C && t > 0.9 && x.showControls();
                                                               }),
                                             ...
                                             d("unbindEvents", function () {
                                                      T || M(),
                                                               ...
                                                               n && (t.unbind(document, n.eventK, x.updateFullscreen), n.isFullscreen() && ((v.hideAnimationDuration = 0), n.exit()), (n = null));
                                             }),
                                             d("destroy", function () {
                                                                                          ...
                                                                                          for (var l = 0; l < N.length; l++)
                                                                                                   (i = N[l]),
                                                                                                            n.indexOf("pswp__" + i.name) > -1 &&
                                                                                                                     (v[i.option]
                                                                                                                              ? (t.removeClass(e, "pswp__element--disabled"), i.onInit && i.onInit(e))
                                             ...
                                             v.fullscreenEl &&
                                                      ...
                                                      n ? (t.bind(document, n.eventK, x.updateFullscreen), x.updateFullscreen(), t.addClass(e.template, "pswp--supports-fs")) : t.removeClass(e.template, "pswp--supports-fs")),
                                             v.preloaderEl &&
                                                      (Z(!0),
                                    ...
                                    (x.update = function () {
                                             C && e.currItem ? (x.updateIndexIndicator(), v.captionEl && (v.addCaptionHTMLFn(e.currItem, i), S(i, "caption--empty", !e.currItem.title)), (b = !0)) : (b = !1), T || M(), D();
                                    }),
                                             ...
                                             if (!g)
                                                      if (n.detail && "mouse" === n.detail.pointerType) {
                                                               ...
                                                               t.hasClass(o, "pswp__img") &&
                                                                        (1 === e.getZoomLevel() && e.getZoomLevel() <= e.currItem.fitRatio ? v.clickToCloseNonZoomable && e.close() : e.toggleDesktopZoom(n.detail.releasePoint));
         ...
         (function (e) {
                  "use strict";
                  var t = window.T4Sstrings,
                           n = e("body"),
                           o = e("#photoswipe_template").html(),
                           i = "pswp__thumbnails",
                           a = "pswp_thumb_active";
                  function r(r) {
                           var l = r.items,
                                    ...
                                    d = {
                                             closeEl: !0,
                                             captionEl: !0,
                                             fullscreenEl: r.fullscreenEl || !0,
                                             zoomEl: !0,
                                             shareEl: r.shareEl || !0,
                                             counterEl: r.counterEl || !0,
                                             arrowEl: !0,
                                             preloaderEl: !0,
                                             history: !1,
                                             maxSpreadZoom: r.maxSpreadZoom || 2,
                                             showHideOpacity: !0,
                                             bgOpacity: 1,
                                             index: r.index,
                                             tapToToggleControls: !0,
                                             shareButtons: [
                                                      { id: "facebook", label: t.pswp_facebook, url: "https://www.facebook.com/sharer/sharer.php?u={{ url }}" },
                                                      { id: "twitter", label: t.pswp_twitter, url: "https://twitter.com/intent/tweet?text={{ text }}&url={{ url }}" },
                                                      { id: "pinterest", label: t.pswp_pinterest, url: "https://www.pinterest.com/pin/create/button/?url={{ url }}&media={{ image_url }}&description={{ text }}" },
                                             ],
                                             getThumbBoundsFn: function (e) {
                                                      var t = c.find(r.parents).eq(e);
                                                      r.global && (t = c.find("a[data-index=" + e + "]").parents(r.parents));
                                                      var n = window.pageYOffset || document.documentElement.scrollTop,
                                                               o = t[0].getElementsByTagName("img")[0].getBoundingClientRect();
                                                      return { x: o.left, y: o.top + n, w: o.width };
                                             },
                                    };
                           n.find(".pswp__t4s").remove(), T4SThemeSP.$appendComponent.after(o), isThemeRTL && ((u = s - u - 1), (l = l.reverse()));
                           var p = document.querySelectorAll(".pswp__t4s")[0],
                                    m = e("." + i),
                                    f = new PhotoSwipe(p, PhotoSwipeUI_Default, l, d);
                           if (
                                    (f.init(),
                                    m.empty(),
                                    f.listen("close", function () {
                                             if (c.hasClass("flickityt4s-enabled")) {
                                                      if (isThemeRTL) var e = s - f.getCurrentIndex();
                                                      else e = f.getCurrentIndex();
                                    ...
                                    if (s <= 1) return;
                                    for (u = 0; u < s; u++) m.append('<div class="pswp_thumb_item" data-index="' + (u + 1) + '"><img loading="lazy" src="' + l[u].src + '" alt="pswp-thumb-img"></div>');
                                    m.find('.pswp_thumb_item[data-index="' + (f.getCurrentIndex() + 1) + '"]').addClass(a),
                                             f.listen("beforeChange", function () {
                                                      var e = f.getCurrentIndex() + 1,
                                             ...
                                             f.listen("afterChange", function () {
                                                      ...
                                                      (t = e("." + a)[0]),
                                                               ...
                                                               i.left + i.width > r.width
                                                                        ? n.animate({ scrollLeft: t.offsetLeft + i.width - r.width + 10 }, 200)
                                                                        : t.offsetLeft < o.scrollLeft && n.animate({ scrollLeft: t.offsetLeft - 10 }, 200);
                                             }),
                  ...
                  (T4SThemeSP.GalleryPhotoSwipe = function () {
                           var t = !1;
                           e("[data-t4s-gallery].flickityt4s-enabled").on("dragEnd.flickityt4s", function (e, n) {
                                    t = !0;
                           }),
                                    e(document).on("click", "[data-t4s-gallery--open]", function (o) {
                                             o.preventDefault();
                                             var i = e(this),
                                                      a = i.parents("[data-t4s-gallery--item]"),
                                                      l = i.closest("[data-t4s-gallery]"),
                                                      s = l.find("[data-pswp-src]");
                                             if (0 == s.length || t) t = !1;
                                             else {
                                                      var u = l.is("[data-t4s-thumb-true]");
                                                      r({
                                                               index: a.index(),
                                                               items: n(s),
                                                               HasThumb: u,
                                                               galleryItems: l,
                                                               parents: "[data-t4s-gallery--item]",
                                                               global: !1,
                                                               maxSpreadZoom: parseFloat(l.attr("data-maxSpreadZoom")),
                                                               fullscreenEl: l.attr("data-fullscreenEl"),
                                                               shareEl: l.attr("data-shareEl"),
                                                               counterEl: l.attr("data-counterEl"),
                                                      });
                                             }
                                    });
                           var n = function (t) {
                                    ...
                                    return (
                                             t.each(function () {
                                                      n.push({ src: e(this).attr("data-pswp-src"), w: e(this).attr("data-pswp-w"), h: e(this).attr("data-pswp-h") });
                                             }),
                                             n
                                    );
                           };
                  }),
                           (T4SThemeSP.videoPoster = function () {
                                             ...
                                             if (!e.is("[loaded]")) {
                                                      ...
                                                      a == "youtube"
                                                               ? (o = o
                                                                          .replace(
                                                                                   "src_t4s",
                                                                                   "//www.youtube.com/embed/" + r + "?enablejsapi=1&showinfo=0&controls=1&modestbranding=1&autoplay=" + +s + "&rel=0" + (u ? "&playlist=" + r + "&loop=1" : "")
                                                                          )
                                                                          .replace("class_t4s", "js-youtube"))
                                                               : a == c
                                                               ? (o = o
                                                                          .replace("src_t4s", "//player.vimeo.com/video/" + r + "?&portrait=0&byline=0&color=" + i.accent_color + "&autoplay=" + +s + "&loop=" + +u)
                                                                          .replace("class_t4s", "js-vimeo"))
                                                               : ((o = '<video src="src_t4s" preload="auto" controls data-autoplay data-loop playsinline></video>'.replace("src_t4s", l)),
                                                                 s && (o = o.replace("data-autoplay", "autoplay")),
         ...
         jQuery_T4NT(document).ready(function (e) {
                  T4SThemeSP.GalleryPhotoSwipe(), T4SThemeSP.videoPoster();
         });
