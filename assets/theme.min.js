                                    ...
                                    initImg() {
                                             ...
                                             return (
                                                      ...
                                                      !(
                                                               !t.image.$item &&
                                                               (null === t.image.src &&
                                                                        ((t.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"), (t.image.bgImage = t.css(t.$item, "background-image"))),
         ...
         var h = (function () {
                           function a(e) {
                                    (this.$container = e.$container),
                                             ...
                                             (this.formartPrice = "ins-del" == this.$productPrice.data("formartPrice") ? "<span class='sr-only' style='display: none'>Current price: </span><ins>money_ins</ins> <span style='display: none' class='sr-only'>Original price: </span><del>money_del</del>" : "<del>money_del</del> <ins>money_ins</ins>"),
